...
public class InterfaceClient  {
    ...
    private static void creationCompte(){
		...
		int numeroRue=LectureClavier.lireEntier("Veuillez entrer votre numero de rue :");

		System.out.println("Veuillez entrer votre rue :");
		...
		int cp=LectureClavier.lireEntier("Veuillez entrer votre code postal :");

		System.out.println("Veuillez entrer votre pays :");
